...
<a class="navbar-brand" href="index.jsp">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="profile.jsp"><span  class="fas fa-file-alt">&nbsp;</span>LearnCoding</a>
        </li>
...
<!--start of main content of body--><!-- Main Blog Content -->
    <div class="container my-5">
        <div class="col-lg-8 mx-auto">
            <div class="blog-card">
                <img src="blog_pics/<%= p.getpPic()%>" alt="Post Image" class="blog-image">
                <div class="p-4">
                    <h2 class="post-title mb-2"><%= p.getpTitle()%></h2>
                    <div class="post-meta mb-3">
                        <i class="fa fa-user"></i> Posted by <strong><a href="#!"><%= user.getName() %></a></strong> |
                        <i class="fa fa-calendar-alt"></i> <%= p.getpDate().toString() %>
                    </div>
                    ...
                    <h5 class="mt-4 mb-2"><i class="fa fa-code"></i> Code Snippet:</h5>
                    <pre class="code-block"><%= p.getpCode() %></pre>
                    <% } %>
                    ...
                    <div class="d-flex justify-content-between align-items-center interaction-buttons">
                        <div>
                            <a href="#!" onclick="doLike(<%= p.getpId()%>,<%=user.getId() %>)" class="btn btn-outline-danger btn-sm me-2">
                                <i class="fa fa-heart me-1"></i> <span class="like-counter"><%= ld.countLikeOnPost(p.getpId())%></span>
                            </a>
                            <a href="#!" class="btn btn-outline-secondary btn-sm">
                                <i class="fa fa-comment"></i> Comment <span class="badge bg-secondary">20</span>
                            </a>
                        </div>
